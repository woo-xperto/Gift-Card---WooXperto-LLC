...
<div class="col_6 left_side_main_img">
    ...
    <div id="gift_card_image_box_html">
        ...
        <div class="image_box">
            <?php
                // echo '<img src="https://leikbreytir.com/dev/wallet/wp-content/uploads/2023/06/afmaelii-3.jpg" id="gift_card_image" class="gift_card_image gcard-image image1" style="display:block;">';
